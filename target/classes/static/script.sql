...
('Viajero', 2, '$2/ mes', 'Accede a beneficios adicionales con una suscripción mensual asequible y flexible.', 0, true, 'USD', 'MONTHLY', 1, NULL, '0', '0', '["Todo lo incluido en el plan Explorador","Acceso a la app móvil (Android / iOS)","Gestión básica de cuenta desde la web","Paquete de 100 Slots para la ruleta","Equipo Inicial (Incluye en todos los personajes)","Soporte técnico estándar","Multiples cuentas de juego (20)","Copias de seguridad cuando desees migrar a otro servidor"]', 'es'),
('Campeón', 12, '$12/ año', 'Disfruta de una experiencia premium durante todo el año con un único pago anual.', 0, true, 'USD', 'YEARLY', 1, NULL, '0', '0', '["Todo lo incluido en el plan Viajero","Ahorro exclusivo anual","Multiples cuentas de juego (20)","Soporte técnico prioritario","Acceso anticipado a eventos especiales","12 USD en puntos"]', 'es'),
...
('Traveler', 2, '$2/ month', 'Enjoy additional benefits with an affordable and flexible monthly subscription.', 0, true, 'USD', 'MONTHLY', 1, NULL, '0', '0', '["Everything included in the Explorer plan","Access to the mobile app (Android / iOS)","Basic account management from the web","100 Slot Pack for the roulette","Starter Equipment (Included for all characters)","Standard technical support","Backups whenever you wish to migrate to another server"]', 'en'),
('Champion', 12, '$12/ year', 'Enjoy a premium experience all year long with a single annual payment.', 0, true, 'USD', 'YEARLY', 1, NULL, '0', '0', '["Everything included in the Traveler plan","Exclusive yearly savings","Priority technical support","Early access to special events"]', 'en'),

-- Portuguese plans
('Explorador', 0, 'Grátis', 'Crie uma conta e comece a aproveitar o jogo completo sem nenhum custo. Perfeito para novos jogadores.', 0, true, 'USD', NULL, NULL, NULL, '0', '0', '["Uma conta de jogo por usuário","Acesso completo a todo o conteúdo do jogo","Atualizações automáticas do cliente","Participação em eventos globais","Acesso ao launcher oficial","Suporte da comunidade pelo fórum (Discord)"]', 'pt'),
('Viajante', 2, '$2/ mês', 'Tenha acesso a benefícios extras com uma assinatura mensal acessível e flexível.', 0, true, 'USD', 'MONTHLY', 1, NULL, '0', '0', '["Tudo incluído no plano Explorador","Acesso ao aplicativo móvel (Android / iOS)","Gerenciamento básico de conta pelo site","Pacote de 100 Slots para a roleta","Equipamento Inicial (Incluído em todos os personagens)","Suporte técnico padrão","Backups sempre que quiser migrar para outro servidor"]', 'pt'),
('Campeão', 12, '$12/ ano', 'Aproveite uma experiência premium durante todo o ano com um único pagamento anual.', 0, true, 'USD', 'YEARLY', 1, NULL, '0', '0', '["Tudo incluído no plano Viajante","Economia anual exclusiva","Suporte técnico prioritário","Acesso antecipado a eventos especiais"]', 'pt');